...
RU = {
    ...
    "intro": (
        ...
        "Сейчас живу в Дананге, работаю удалённо и спокойно закрываю график Москвы. "
        "Открыт к найму и к длинным проектным контрактам."
    ),
    "stack_title": "Стек",
    "stack": [
        ...
        ("Инфра", "Docker, nginx, Linux, Kubernetes, AWS"),
        ("AI / наблюдение", "OpenAI / Claude / Gemini API, OpenRouter, RAG, MCP, LangChain, Sentry, Prometheus, Grafana"),
    ],
    "exp_title": "Опыт",
    "jobs": [
        {
...
EN = {
    ...
    "intro": (
        ...
        "I live in Da Nang, work remotely, and can follow Moscow time. "
        "Open to full-time remote roles and longer contracts."
    ),
    "stack_title": "Stack",
    "stack": [
        ...
        ("Infra", "Docker, nginx, Linux, Kubernetes, AWS"),
        ("AI / observability", "OpenAI / Claude / Gemini API, OpenRouter, RAG, MCP, LangChain, Sentry, Prometheus, Grafana"),
    ],
